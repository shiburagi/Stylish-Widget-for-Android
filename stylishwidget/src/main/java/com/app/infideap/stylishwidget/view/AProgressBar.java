...
//        setGravity(Gravity.RIGHT);
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.progressAttr);
        setProgressValue(a.getFloat(R.styleable.progressAttr_sw_progressValue, 0f));
        ...
        setProgressTextSize(a.getDimension(R.styleable.progressAttr_sw_progressTextSize,
        ...
        setProgressIconPadding(a.getDimensionPixelSize(R.styleable.progressAttr_sw_progressIconPadding,0));

        setProgressColor(a.getColor(R.styleable.progressAttr_sw_progressColor, Color.rgb(255, 255, 255)));
        setProgressBackground(a.getColor(R.styleable.progressAttr_sw_progressBackground, Color.argb(0, 0, 0, 0)));

        refresh();

        if (!isInEditMode()) {
            if (a.getBoolean(R.styleable.progressAttr_sw_withAnimation, false))
                withAnimation(a.getInteger(R.styleable.progressAttr_sw_duration, 1000));
        }
        a.recycle();
